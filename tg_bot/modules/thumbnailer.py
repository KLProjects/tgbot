...
from tg_bot import LOGGER, SUDO_USERS, SUPPORT_USERS, dispatcher
...
def generate_thumb_nail(bot: Bot, update: Update):
    ...
    if int(from_user_id) in SUDO_USERS + SUPPORT_USERS:
        ...
        bot.send_message(
            from_user_id,
            text="Only admins are authorized to access this module.",
            reply_to_message_id=msg.message_id,
        )
...
dispatcher.add_handler(
    MessageHandler(Filters.photo & Filters.private, generate_thumb_nail)
)
